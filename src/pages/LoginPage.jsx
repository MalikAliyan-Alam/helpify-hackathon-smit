  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center py-12 px-4 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
        <div className="absolute -top-24 -left-24 w-96 h-96 bg-[var(--accent)] opacity-[0.07] blur-[120px] rounded-full"></div>
        <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-blue-500 opacity-[0.05] blur-[120px] rounded-full"></div>
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          <Link to="/" className="inline-flex flex-col items-center group">
            ...
            <h1 className="text-4xl font-black text-[var(--text-primary)] tracking-tighter mb-2">Welcome back</h1>
            <p className="text-[var(--text-secondary)] font-medium">Access your community command center.</p>
          </Link>
        </div>
        ...
        <Card className="border border-[var(--glass-border)] shadow-2xl rounded-[32px] p-8 lg:p-10 bg-[var(--glass-bg)] backdrop-blur-2xl">
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-[10px] font-black uppercase tracking-widest">
              <span className="px-4 bg-transparent text-[var(--text-secondary)]">Or secure sign in</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2 px-1">
                <label className="block text-xs font-black text-[var(--text-secondary)] uppercase tracking-widest">Password</label>
                <Link to="/forgot-password" size="sm" className="text-[10px] font-black uppercase tracking-widest text-[var(--accent)] hover:underline">Forgot?</Link>
              </div>
              <input 
                type="password" 
                required
          ...
          <div className="mt-8 text-center text-sm text-[var(--text-secondary)]">
            Don't have an account? <Link to="/signup" className="text-[var(--accent)] font-bold hover:underline ml-1">Sign up</Link>
          </div>
        </Card>
      </div>
    </div>
